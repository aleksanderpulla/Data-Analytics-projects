...
```{r displaying a brief overview of datasets}
head(april_2020)
head(may_2020)
head(june_2020)
head(july_2020)
...
nrow(all_trips)
length(unique(all_trips$ride_id)) == nrow(all_trips) # The result indicates that there are duplicate values
```
